...
class TDummyData {
  static final List<CategoryModel> categories = [
    ...
    CategoryModel(
        id: '2', name: 'Electronics', image: TImages.toyIcon, isFeatured: true),
    CategoryModel(
        id: '3', name: 'Clothes', image: TImages.jerseyIcon, isFeatured: true),
    CategoryModel(
    ...
    CategoryModel(
        ...
        isFeatured: true),
    CategoryModel(
        id: '8', name: 'Jewelery', image: TImages.jewelIcon, isFeatured: true),
